...
public class studentregistration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(270, 490, 120, 30);
        ...
        jButton3.setBounds(450, 490, 120, 30);
        ...
        jButton4.setBounds(80, 490, 120, 30);

        setBounds(0, 0, 739, 619);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            try
            {
                ...
                String q="insert into addstudent values(?,?,?,?,?,?,?)";
                ...
                if(res>0)
                {
                    JOptionPane.showMessageDialog(rootPane, "Student Added Succesfully");
                ...
                {
                    JOptionPane.showMessageDialog(rootPane, "Student NOT Added Succesfully");
                    textField1.setText("");
                    textField2.setText("");
                    textArea1.setText("");
...
this.dispose();// TODO add your handling code here:
    ...
    private void setIcon() {
       setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("images1.png")));
    }
}
